...
export function LoginForm({
    ...
    const displayError = configError || externalError || error;
        ...
        >
            <FieldGroup>
                <div className="flex flex-col items-center gap-1 text-center">
                    ...
                    <p className="text-sm text-balance text-black dark:text-zinc-300 font-medium">
                ...
                <Field>
                    <div className="flex items-center">
                        ...
                        <Link
                            ...
                            className="ml-auto text-sm underline-offset-4 hover:underline text-black dark:text-zinc-300 font-medium"
                        >
                ...
                <Field>
                    <Button
                        ...
                        disabled={googleLoading || loading || Boolean(configError)}
                    >
                        {googleLoading ? (
                            <>
                                <Loader2 className="mr-2 h-4 w-4 animate-spin" />
