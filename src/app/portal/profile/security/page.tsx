    ...
    const handleLinkGoogle = async () => {
        ...
        try {
            const { error } = await supabase.auth.linkIdentity({
                provider: 'google',
                options: {
                    redirectTo: `${window.location.origin}/auth/callback?next=/portal/profile/security`,
                },
            });
    ...
    const handleEmailChange = async (e: React.FormEvent) => {
        ...
        try {
            const { error } = await supabase.auth.updateUser({
                ...
                emailRedirectTo: `${window.location.origin}/auth/callback?next=/portal/profile/security`,
            });
        ...
        <div className="p-8 max-w-2xl mx-auto space-y-8">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Update your email address. A verification link will be sent.
                    </CardDescription>
                </CardHeader>
                <CardContent>
