-- Combined Migration Script for Bills Table
-- This script combines the necessary migrations to fix the missing bills table
-- Run this in your Supabase SQL Editor

-- ============================================
-- From: 015_invoicing_billing.sql
-- ============================================
...
-- ============================================
-- 8. QUALIFICATIONS PREVIEW ENHANCEMENTS
-- From: 047_qualification_prerequisites_certificate_preview.sql
-- ============================================
